...
<head>
    ...
    <link rel="stylesheet" href="my_attendence1.css">
    ...
    <div id="container">
        ...
        <div id="down">
            ...
            <h5 style="color: #f40b0b; margin-left:5px;"><i class="fa-solid fa-asterisk fa-2xs" style="color: #f40b0b; margin-left:1000px;margin-top: 50px;"> </i> indicates required questions</h5>
                <form name="f1" action="my_attendence.php" method="post">
                    <table id="table1">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td> <input type="submit" name="sub" value="View Attendence" id="btn" onclick="return valid()"> </td>
                        </tr>
                    </table>
                </form>    
            </div>
