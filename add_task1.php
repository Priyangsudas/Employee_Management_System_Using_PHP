...
<head>
    ...
    <style>
        ...
        function valid()
        {
            ...
            {
                alert("Pleasr Enter Task Details");
                return false;
            }
            else if (c=="")
            {
                alert("Pleasr Enter Submission Date");
                return false;
            }
            else
            {
    ...
    <div id="container">
        ...
        <div id="down">
            ...
            <div id="right_down">
                ...
                <form name="f1" action="add_task.php" method="post">
                    <table id="table1">
                        <tr>
                        ...
                        <tr>
                            <td><p class="p4">Task Details<i class="fa-solid fa-asterisk fa-2xs" style="color: #f40b0b; margin-left:5px;"></i></p></td>
                        </tr>
                        <tr>
                            <td><textarea name="txt2" class="text2" placeholder="Enter Task Details"></textarea></td>
                        </tr>
                        <tr>
                            <td><p class="p4">Submission Date<i class="fa-solid fa-asterisk fa-2xs" style="color: #f40b0b; margin-left:5px;"></i></p></td>
                        </tr>
                        <tr>
                            <td><input type="date" name="txt3" class="text1"></td>
                        </tr>
                            <td> <input type="submit" name="sub" value="Add Task" id="btn" onclick="return valid()"> </td>
                        </tr>
                    </table>
                </form>
            </div>
