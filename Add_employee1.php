    ...
    <div id="container">
        ...
        <div id="down">
            ...
            <div id="right_down">
                ...
                <form name="f1" action="Add_Employee.php" method="post">
                ...
                <table width="900" height="40">
                    ...
                    <tr>
                        <td><input type="text" name="txt1" class="text1" placeholder="Enter your name"></td>
                        <td><input type="date" name="txt2" class="text1"></td>
                        <td><input type="email" name="txt3" class="text1" placeholder="Enter your email"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><input type="text" name="txt4" class="text1" placeholder="Enter mobile number"></td>
                        <td>
                        ...
                        <td><input type="text" name="txt6" class="text1" placeholder="Enter your adress"></td>
                    </tr>
                </table>
                ...
                <table width="900" height="40">
                    ...
                    <tr>
                        <td><input type="text" name="txt7" class="text1" placeholder="Enter Employee ID"></td>
                        <td><input type="text" name="txt8" class="text1" placeholder="Enter your Designation"></td>
                        <td><input type="date" name="txt9" class="text1"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><input type="text" name="txt10" class="text1" placeholder="Enter Depertment ID"></td>
                        <td><input type="text" name="txt11" class="text1" placeholder="Enter your salary"></td>
                        <td><input type="text" name="txt12" class="text1" placeholder="Enter project done"></td>
                    </tr>


		<tr>
			<td> <input type="submit" name="sub" value="Add New Employee" id="btn" onclick="return valid()"> </td>
		</tr>
                </table>
